...
@Command
public class CommandBeibao implements CommandEntrypoint {
        ...
        commands.registerCommand(
                CommandNode.createRoot("悲报")
                        ...
                        .withExecutor((bot, event, args) -> {
                            ...
                            if (this.data == null) {
                                this.data = this.staticService.get(EssentialBot.class).getAsByteArray("assets/beibao.jpg");
                            }
                            if (this.data == null) {
                                return;
                            }
...
//                                System.out.println(html);
    ...
    private String buildHtml(String text, byte[] imgData) {
        ...
        String fontColor = "#000500";
        String strokeColor = "#c6c6c6";
        int maxFontSize = 120;
        int minFontSize = 76;
        int offsetWidth = 900;
