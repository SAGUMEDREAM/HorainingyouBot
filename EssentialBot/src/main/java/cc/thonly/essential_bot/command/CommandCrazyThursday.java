...
@Command
public class CommandCrazyThursday implements CommandEntrypoint {
    public static final String[] TEXT_LIST = new String[]{
    ...
    public void registerCommand(Commands commands) {
        commands.registerCommand(
                CommandNode.createRoot("随机星期四")
                        .withAliasName("随机KFC", "随机kfc", "生成疯狂星期四", "tskfc")
                        .withExecutor((bot, event, args) -> {
                            MsgTool.reply(bot, event, Mth.getRandomElement(TEXT_LIST));
                        })
        );
