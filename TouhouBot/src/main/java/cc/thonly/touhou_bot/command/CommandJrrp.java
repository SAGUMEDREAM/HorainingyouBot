...
import cc.thonly.touhou_bot.TouhouBot;
import cc.thonly.touhou_bot.view.custom.JRRPView;
import cc.thonly.touhou_bot.data.TouhouFortuneSlips;
...
public class CommandJrrp implements CommandEntrypoint {
    ...
    public TouhouFortuneSlips getListFromJsonFile() {
        ...
        try (InputStream is = TouhouBot.class.getResourceAsStream(
