...
public class EveryEvents {
    ...
    public static final EventKey<ReceiveGroupAddRequestEvent> GROUP_INVITE_REQUEST = EventBusFactory.key(ReceiveGroupAddRequestEvent.class);;
    public static final EventKey<GroupMemberJoinEvent> GROUP_MEMBER_JOIN = EventBusFactory.key(GroupMemberJoinEvent.class);
    public static final EventKey<GroupMemberExitEvent> GROUP_MEMBER_EXIT = EventBusFactory.key(GroupMemberExitEvent.class);
    public static final EventKey<GroupAdminEvent> GROUP_ADMIN_NOTICE = EventBusFactory.key(GroupAdminEvent.class);
